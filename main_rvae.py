...
from models.modules import RVAE_Xray
...
def main():
    ...
    for fold, (train_idx,test_idx) in enumerate(splits.split(np.arange(m))):
        ...
        model = RVAE_Xray(gaussian_target_distance=5, latent_size=args.latent_size, dist_weight=1, use_mse=args.use_mse)
        ...
        for epoch in range(args.start_epoch, args.epochs):
            ...
            test_loss = vu.test_rvae_supervised(test_loader, model, regularizer_gaussian, epoch, log)
